...
Tested Up To: 3.0
Tags:  template, gallery, comments

== Description ==

Hers a simple plugin that fixes the gallery so it validates by pushing the css into <head> and a couple of other little tweaks.
